...
parser.add_argument(
    "--dir", type=str, default="./outputs", help="Path to read or save checkpoints"
)
...
if __name__ == "__main__":
    ...
    if args.log_wandb:
        ...
        run = wandb.init(project=project_name, config=config['lora'][0])
        run.name = config['lora'][0]['name']
